...
ARGS = [
    CLIArgumentDescription(
        ...
        default_value=2,
        short_name='vs',
        full_name='vector_size',
        value_name='VECTOR_SIZE',
        help_message=
        """Specify the number of parameters the function will have""",
        action_cls=CheckPositiveIntegerConstraintAction),
    CLIArgumentDescription(
        _type=float,
        default_value=-2.048,
        short_name='plb',
        full_name='parameter_lower_bound',
        value_name='LOWER_BOUND',
        help_message=
        """Specify the minimum value the funcion's parameter is allowed to have""",
        action_cls=NoConstraintAction),
    CLIArgumentDescription(
        _type=float,
        default_value=2.048,
        short_name='pub',
        full_name='parameter_upper_bound',
        value_name='UPPER_BOUND',
        help_message=
        """Specify the maximum value the funcion's parameter is allowed to have""",
        action_cls=NoConstraintAction),
    CLIArgumentDescription(
        _type=int,
        default_value=100,
